...
//typedef xf::cv::ap_axiu<DATA_WIDTH,1,1,1> interface_t; //xf::cv::ap_axiu<DATA_WIDTH,1,1,1>
...
void resize_accel(stream_t& src, stream_t& dst,int src_rows, int src_cols,int dst_rows, int dst_cols)
{
