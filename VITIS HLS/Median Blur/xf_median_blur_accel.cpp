...
void median_blur_accel(stream_t& img_in, int rows, int cols, stream_t& img_out) {
// clang-format off
...
// clang-format off
    ...
    // Run xfOpenCV kernel:
    xf::cv::medianBlur<WINDOW_SIZE, XF_BORDER_REPLICATE, IN_TYPE, HEIGHT, WIDTH, NPPCX>(imgInput, imgOutput);
