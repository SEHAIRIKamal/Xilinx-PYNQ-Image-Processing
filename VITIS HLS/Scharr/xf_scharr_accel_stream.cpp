...
void scharr_accel(stream_t& img_inp, stream_o& img_out, float alpha, int shift, int rows, int cols)
{
// clang-format off
    ...
    xf::cv::Scharr<XF_BORDER_CONSTANT, TYPE, TYPE_3, HEIGHT, WIDTH, NPIX>(in_mat, _dstgx,_dstgy);
