...
HD_PWD='C:/Xilinx/workspace/medianblur/medianblur.runs/medianblur_design_axis_dwidth_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log medianblur_design_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source medianblur_design_axis_dwidth_converter_0_0.tcl
