...
HD_PWD='C:/Xilinx/workspace/medianblur/medianblur.runs/medianblur_design_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log medianblur_design_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source medianblur_design_auto_us_1.tcl
