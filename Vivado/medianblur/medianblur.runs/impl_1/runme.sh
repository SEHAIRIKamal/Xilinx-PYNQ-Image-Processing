...
HD_PWD='C:/Xilinx/workspace/medianblur/medianblur.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log medianblur_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source medianblur_design_wrapper.tcl -notrace
