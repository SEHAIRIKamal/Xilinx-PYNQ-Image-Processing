...
HD_PWD='C:/Xilinx/workspace/sobel3weightedadd/sobel3weightedadd.runs/sobel_design_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_design_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobel_design_auto_pc_1.tcl
