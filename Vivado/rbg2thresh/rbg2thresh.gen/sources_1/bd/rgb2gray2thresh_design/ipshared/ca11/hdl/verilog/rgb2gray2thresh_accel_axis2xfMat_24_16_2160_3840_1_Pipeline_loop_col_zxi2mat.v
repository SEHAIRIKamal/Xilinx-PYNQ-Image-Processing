...
module rgb2gray2thresh_accel_axis2xfMat_24_16_2160_3840_1_Pipeline_loop_col_zxi2mat (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln78_fu_107_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln78_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        axi_data_reg_138 <= imgInput_TDATA;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln78_fu_107_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln78_fu_107_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln78_fu_107_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((p_imgInput_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln78_fu_107_p2 == 1'd0) & (imgInput_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((p_imgInput_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln78_fu_107_p2 == 1'd0) & (imgInput_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((p_imgInput_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln78_fu_107_p2 == 1'd0) & (imgInput_TVALID == 1'b0) & (ap_start_int == 1'b1)));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((icmp_ln78_fu_107_p2 == 1'd0) & (imgInput_TVALID == 1'b0));
end
...
assign icmp_ln78_fu_107_p2 = ((ap_sig_allocacmp_j == p_read1_cast_cast_fu_95_p1) ? 1'b1 : 1'b0);
...
endmodule //rgb2gray2thresh_accel_axis2xfMat_24_16_2160_3840_1_Pipeline_loop_col_zxi2mat
