...
module rgb2gray2thresh_accel_axis2xfMat_24_16_2160_3840_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
rgb2gray2thresh_accel_axis2xfMat_24_16_2160_3840_1_Pipeline_loop_col_zxi2mat grp_axis2xfMat_24_16_2160_3840_1_Pipeline_loop_col_zxi2mat_fu_112(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln76_fu_141_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln76_fu_141_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (p_imgInput_cols_c_full_n == 1'b0) | (p_imgInput_rows_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_80 <= 12'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln76_fu_141_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln76_fu_141_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign icmp_ln76_fu_141_p2 = ((i_fu_80 == p_read) ? 1'b1 : 1'b0);
...
endmodule //rgb2gray2thresh_accel_axis2xfMat_24_16_2160_3840_1_s
