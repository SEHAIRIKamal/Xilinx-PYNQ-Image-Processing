...
// 
// ==============================================================
#ifndef XRGB2GRAY2THRESH_ACCEL_H
#define XRGB2GRAY2THRESH_ACCEL_H
...
#include <stddef.h>
#endif
#include "xrgb2gray2thresh_accel_hw.h"
...
} XRgb2gray2thresh_accel_Config;
#endif

typedef struct {
    u64 Control_BaseAddress;
    u32 IsReady;
} XRgb2gray2thresh_accel;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XRgb2gray2thresh_accel_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XRgb2gray2thresh_accel_ReadReg(BaseAddress, RegOffset) \
