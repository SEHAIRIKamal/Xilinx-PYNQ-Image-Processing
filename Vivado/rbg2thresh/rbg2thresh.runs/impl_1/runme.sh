...
HD_PWD='C:/Xilinx/workspace/rbg2thresh/rbg2thresh.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray2thresh_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb2gray2thresh_design_wrapper.tcl -notrace
