...
HD_PWD='C:/Xilinx/workspace/rbg2thresh/rbg2thresh.runs/rgb2gray2thresh_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray2thresh_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2gray2thresh_design_auto_pc_0.tcl
