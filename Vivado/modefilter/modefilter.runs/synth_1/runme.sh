...
HD_PWD='C:/Xilinx/workspace/modefilter/modefilter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modefilter_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modefilter_design_wrapper.tcl
