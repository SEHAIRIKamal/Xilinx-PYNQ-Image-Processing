...
HD_PWD='C:/Xilinx/workspace/modefilter/modefilter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modefilter_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modefilter_design_wrapper.tcl -notrace
