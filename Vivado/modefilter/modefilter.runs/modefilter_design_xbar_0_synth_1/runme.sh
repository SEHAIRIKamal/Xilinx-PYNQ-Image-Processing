...
HD_PWD='C:/Xilinx/workspace/modefilter/modefilter.runs/modefilter_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modefilter_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modefilter_design_xbar_0.tcl
