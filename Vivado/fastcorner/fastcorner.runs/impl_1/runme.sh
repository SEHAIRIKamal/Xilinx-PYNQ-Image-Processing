...
HD_PWD='C:/Xilinx/workspace/fastcorner/fastcorner.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fastcorner_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fastcorner_design_wrapper.tcl -notrace
