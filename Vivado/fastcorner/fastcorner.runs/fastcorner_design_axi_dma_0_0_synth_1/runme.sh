...
HD_PWD='C:/Xilinx/workspace/fastcorner/fastcorner.runs/fastcorner_design_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fastcorner_design_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fastcorner_design_axi_dma_0_0.tcl
