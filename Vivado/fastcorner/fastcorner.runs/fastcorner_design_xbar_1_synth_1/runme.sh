...
HD_PWD='C:/Xilinx/workspace/fastcorner/fastcorner.runs/fastcorner_design_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fastcorner_design_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fastcorner_design_xbar_1.tcl
