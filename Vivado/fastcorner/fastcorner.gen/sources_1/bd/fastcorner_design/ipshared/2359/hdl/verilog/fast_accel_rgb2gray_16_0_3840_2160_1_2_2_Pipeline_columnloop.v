...
module fast_accel_rgb2gray_16_0_3840_2160_1_2_2_Pipeline_columnloop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
fast_accel_mul_8ns_15ns_22_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
fast_accel_mac_muladd_8ns_12ns_22ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
...
fast_accel_mac_muladd_8ns_15ns_22ns_23_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_1_reg_192 <= {{imgInput_data_dout[15:8]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((imgInput_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((imgInput_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((imgInput_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign p_2_fu_120_p4 = {{imgInput_data_dout[23:16]}};

assign p_fu_106_p1 = imgInput_data_dout[7:0];

endmodule //fast_accel_rgb2gray_16_0_3840_2160_1_2_2_Pipeline_columnloop
