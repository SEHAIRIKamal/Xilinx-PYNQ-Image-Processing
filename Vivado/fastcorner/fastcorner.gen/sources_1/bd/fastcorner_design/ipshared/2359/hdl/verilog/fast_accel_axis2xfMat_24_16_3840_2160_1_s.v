...
module fast_accel_axis2xfMat_24_16_3840_2160_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [0:0] icmp_ln45_fu_141_p2;
wire    ap_CS_fsm_state3;
reg   [11:0] i_fu_76;
wire   [11:0] i_6_fu_146_p2;
wire   [31:0] zext_ln45_fu_137_p1;
reg   [2:0] ap_NS_fsm;
...
fast_accel_axis2xfMat_24_16_3840_2160_1_Pipeline_loop_col_zxi2mat grp_axis2xfMat_24_16_3840_2160_1_Pipeline_loop_col_zxi2mat_fu_108(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln45_fu_141_p2 == 1'd0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln45_fu_141_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((real_start == 1'b0) | (imgInput_cols_c_full_n == 1'b0) | (imgInput_rows_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_76 <= 12'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln45_fu_141_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln45_fu_141_p2 == 1'd0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign icmp_ln45_fu_141_p2 = (($signed(zext_ln45_fu_137_p1) < $signed(p_read)) ? 1'b1 : 1'b0);
...
assign zext_ln45_fu_137_p1 = i_fu_76;

endmodule //fast_accel_axis2xfMat_24_16_3840_2160_1_s
