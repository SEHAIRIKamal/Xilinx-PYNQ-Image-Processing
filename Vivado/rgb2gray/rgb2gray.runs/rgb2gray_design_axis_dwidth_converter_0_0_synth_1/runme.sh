...
HD_PWD='C:/Xilinx/workspace/rgb2gray/rgb2gray.runs/rgb2gray_design_axis_dwidth_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray_design_axis_dwidth_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2gray_design_axis_dwidth_converter_0_0.tcl
