...
HD_PWD='C:/Xilinx/workspace/rgb2gray/rgb2gray.runs/rgb2gray_design_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray_design_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2gray_design_auto_us_1.tcl
