...
HD_PWD='C:/Xilinx/workspace/rgb2gray/rgb2gray.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb2gray_design_wrapper.tcl -notrace
