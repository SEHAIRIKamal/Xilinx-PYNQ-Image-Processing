...
HD_PWD='C:/Xilinx/workspace/rgb2gray/rgb2gray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2gray_design_wrapper.tcl
