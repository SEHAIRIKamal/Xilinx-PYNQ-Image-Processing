...
HD_PWD='C:/Xilinx/workspace/harris_project/harris_project.runs/harris_design_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harris_design_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harris_design_axi_dma_0_0.tcl
