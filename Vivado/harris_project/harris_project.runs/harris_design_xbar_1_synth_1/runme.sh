...
HD_PWD='C:/Xilinx/workspace/harris_project/harris_project.runs/harris_design_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harris_design_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harris_design_xbar_1.tcl
