...
HD_PWD='C:/Xilinx/workspace/harris_project/harris_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log harris_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source harris_design_wrapper.tcl -notrace
