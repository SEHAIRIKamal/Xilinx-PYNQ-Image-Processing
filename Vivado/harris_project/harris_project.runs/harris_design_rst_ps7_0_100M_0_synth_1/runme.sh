...
HD_PWD='C:/Xilinx/workspace/harris_project/harris_project.runs/harris_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harris_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harris_design_rst_ps7_0_100M_0.tcl
