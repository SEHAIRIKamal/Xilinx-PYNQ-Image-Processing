...
module cornerHarris_accel_rgb2gray_16_0_3840_2160_1_2_2_Pipeline_columnloop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
cornerHarris_accel_mul_8ns_15ns_22_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 22 ))
mul_8ns_15ns_22_1_1_U35(
    .din0(mul_ln886_fu_140_p0),
    .din1(mul_ln886_fu_140_p1),
    .dout(mul_ln886_fu_140_p2)
);

cornerHarris_accel_mac_muladd_8ns_12ns_22ns_22_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 12 ),
    .din2_WIDTH( 22 ),
    .dout_WIDTH( 22 ))
mac_muladd_8ns_12ns_22ns_22_4_1_U36(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_159_p0),
    .din1(grp_fu_159_p1),
...
cornerHarris_accel_mac_muladd_8ns_15ns_22ns_23_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 15 ),
    .din2_WIDTH( 22 ),
    .dout_WIDTH( 23 ))
mac_muladd_8ns_15ns_22ns_23_4_1_U37(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_167_p0),
    .din1(grp_fu_167_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        p_1_reg_192 <= {{in_mat_data_dout[15:8]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter5 == 1'b1))) begin
        grayin_mat_data_blk_n = grayin_mat_data_full_n;
    end else begin
...
assign add_ln5506_fu_95_p2 = (ap_sig_allocacmp_j_load + 16'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((in_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((in_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((grayin_mat_data_full_n == 1'b0) & (ap_enable_reg_pp0_iter5 == 1'b1)) | ((in_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp0_stage0_iter5 = (grayin_mat_data_full_n == 1'b0);
end
...
assign grayin_mat_data_din = {{grp_fu_167_p3[22:15]}};
...
assign icmp_ln5506_fu_89_p2 = ((ap_sig_allocacmp_j_load == empty) ? 1'b1 : 1'b0);
...
assign p_2_fu_120_p4 = {{in_mat_data_dout[23:16]}};

assign p_fu_106_p1 = in_mat_data_dout[7:0];

endmodule //cornerHarris_accel_rgb2gray_16_0_3840_2160_1_2_2_Pipeline_columnloop
