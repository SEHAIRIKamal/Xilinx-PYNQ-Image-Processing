...
module cornerHarris_accel_xFSobelFilter3x3_Pipeline_Col_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [12:0] col_2_fu_92;
wire   [12:0] col_3_fu_376_p2;
wire    ap_loop_init;
...
cornerHarris_accel_xFSobel3x3_1_1_0_4_s grp_xFSobel3x3_1_1_0_4_s_fu_316(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cornerHarris_accel_mux_3_2_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 8 ),
    .din1_WIDTH( 8 ),
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_col = col_2_fu_92;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter6 == 1'b1) & (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)))) | ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter6 == 1'b1) & (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)))) | ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp93 = (((ap_enable_reg_pp0_iter6 == 1'b1) & (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)))) | ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter6 == 1'b1) & (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)))) | ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_ignore_call13 = ((ap_predicate_op61_read_state2 == 1'b1) & (grayin_mat_data_empty_n == 1'b0));
end
...
always @ (*) begin
    ap_block_state7_pp0_stage0_iter6 = (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)));
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter6_ignore_call13 = (((grady_mat_data_full_n == 1'b0) & (icmp_ln250_reg_615_pp0_iter5_reg == 1'd0)) | ((icmp_ln250_reg_615_pp0_iter5_reg == 1'd0) & (gradx_mat_data_full_n == 1'b0)));
end
...
assign col_3_fu_376_p2 = (ap_sig_allocacmp_col + 13'd1);

assign gradx_mat_data_din = GradientValuesX_reg_649;

assign grady_mat_data_din = GradientValuesY_reg_654;
...
endmodule //cornerHarris_accel_xFSobelFilter3x3_Pipeline_Col_Loop
