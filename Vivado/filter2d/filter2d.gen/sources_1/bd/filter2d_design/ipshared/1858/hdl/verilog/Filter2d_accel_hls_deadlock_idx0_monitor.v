...
module Filter2d_accel_hls_deadlock_idx0_monitor ( // for module Filter2d_accel_Filter2d_accel_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[2] = idx1_block & (1'b0 | axis_block_sigs[0]);
assign process_idle_vec[2] = inst_idle_sigs[2];
assign process_chan_block_vec[2] = inst_block_sigs[2];
assign process_axis_block_vec[3] = idx3_block & (1'b0 | axis_block_sigs[1]);
assign process_idle_vec[3] = inst_idle_sigs[3];
assign process_chan_block_vec[3] = inst_block_sigs[3];
assign process_axis_block_vec[4] = idx4_block & (1'b0 | axis_block_sigs[2]);
