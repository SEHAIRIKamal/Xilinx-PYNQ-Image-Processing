...
HD_PWD='C:/Xilinx/workspace/filter2d/filter2d.runs/filter2d_design_Filter2d_accel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter2d_design_Filter2d_accel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter2d_design_Filter2d_accel_0_0.tcl
