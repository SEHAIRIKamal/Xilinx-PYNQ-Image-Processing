...
module sobel_accel_convertTo_3_0_2160_3840_1_2_2_8 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start;
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_done;
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_idle;
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_ready;
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_p_dst_data_read;
wire   [7:0] grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_dst_1_data_din;
wire    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_dst_1_data_write;
reg    grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 3'd1;
#0 grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg = 1'b0;
end

sobel_accel_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start),
    .ap_done(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_done),
    .ap_idle(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_idle),
    .ap_ready(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_ready),
    ...
    .p_dst_data_read(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_p_dst_data_read),
    .dst_1_data_din(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_dst_1_data_din),
    .dst_1_data_num_data_valid(2'd0),
    .dst_1_data_fifo_cap(2'd0),
    .dst_1_data_full_n(dst_1_data_full_n),
    .dst_1_data_write(grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_dst_1_data_write),
    .width(width_reg_160),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg <= 1'b0;
    end else begin
        if (((icmp_ln75_fu_132_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg <= 1'b1;
        end else if ((grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_ready == 1'b1)) begin
            grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end
...
assign dst_1_data_din = grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_dst_1_data_din;

assign grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start = grp_convertTo_3_0_2160_3840_1_2_2_8_Pipeline_COL_LOOP_fu_80_ap_start_reg;
...
endmodule //sobel_accel_convertTo_3_0_2160_3840_1_2_2_8
