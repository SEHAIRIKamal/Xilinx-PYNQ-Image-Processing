...
HD_PWD='C:/Xilinx/workspace/Gaussianfilter/Gaussianfilter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gaussianblur_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gaussianblur_design_wrapper.tcl
