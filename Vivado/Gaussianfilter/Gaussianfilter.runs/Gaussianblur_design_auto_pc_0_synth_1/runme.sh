...
HD_PWD='C:/Xilinx/workspace/Gaussianfilter/Gaussianfilter.runs/Gaussianblur_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gaussianblur_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gaussianblur_design_auto_pc_0.tcl
