...
HD_PWD='C:/Xilinx/workspace/Gaussianfilter/Gaussianfilter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Gaussianblur_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Gaussianblur_design_wrapper.tcl -notrace
