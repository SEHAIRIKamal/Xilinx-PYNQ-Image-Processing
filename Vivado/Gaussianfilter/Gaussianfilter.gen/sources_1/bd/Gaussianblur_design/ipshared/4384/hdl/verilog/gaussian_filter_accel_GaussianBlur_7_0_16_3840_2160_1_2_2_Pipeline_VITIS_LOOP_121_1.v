...
module gaussian_filter_accel_GaussianBlur_7_0_16_3840_2160_1_2_2_Pipeline_VITIS_LOOP_121_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [2:0] i_5_reg_168;
reg   [2:0] i_5_reg_168_pp0_iter1_reg;
reg   [2:0] i_5_reg_168_pp0_iter2_reg;
reg   [2:0] i_5_reg_168_pp0_iter3_reg;
reg   [2:0] i_5_reg_168_pp0_iter4_reg;
wire   [0:0] icmp_ln121_fu_105_p2;
reg   [0:0] icmp_ln121_reg_173_pp0_iter1_reg;
reg   [0:0] icmp_ln121_reg_173_pp0_iter2_reg;
reg   [0:0] icmp_ln121_reg_173_pp0_iter3_reg;
reg   [0:0] icmp_ln121_reg_173_pp0_iter4_reg;
wire   [2:0] add_ln122_fu_117_p2;
reg   [2:0] add_ln122_reg_177;
...
reg   [31:0] x_reg_187;
reg   [31:0] mul5_i_reg_193;
reg   [31:0] mul6_i_reg_198;
wire    ap_block_pp0_stage4_11001;
wire   [31:0] grp_fu_87_p2;
reg   [31:0] t_reg_203;
wire   [31:0] grp_fu_76_p2;
reg   [31:0] sum_3_reg_214;
reg    ap_enable_reg_pp0_iter0_reg;
wire    ap_block_pp0_stage0_subdone;
wire   [63:0] trunc_ln122_cast_fu_136_p1;
...
gaussian_filter_accel_fadd_32ns_32ns_32_5_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
gaussian_filter_accel_sitofp_32s_32_6_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 6 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
sitofp_32s_32_6_no_dsp_1_U35(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_84_p0),
    .ce(1'b1),
...
gaussian_filter_accel_fexp_32ns_32ns_32_10_full_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 10 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fexp_32ns_32ns_32_10_full_dsp_1_U36(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(32'd0),
    .din1(mul6_i_reg_198),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            sum_fu_42 <= sum_3_reg_214;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln121_fu_105_p2 == 1'd0))) begin
        add_ln122_reg_177 <= add_ln122_fu_117_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_5_reg_168 <= ap_sig_allocacmp_i_5;
        i_5_reg_168_pp0_iter1_reg <= i_5_reg_168;
        i_5_reg_168_pp0_iter2_reg <= i_5_reg_168_pp0_iter1_reg;
        i_5_reg_168_pp0_iter3_reg <= i_5_reg_168_pp0_iter2_reg;
        i_5_reg_168_pp0_iter4_reg <= i_5_reg_168_pp0_iter3_reg;
        icmp_ln121_reg_173 <= icmp_ln121_fu_105_p2;
        icmp_ln121_reg_173_pp0_iter1_reg <= icmp_ln121_reg_173;
        icmp_ln121_reg_173_pp0_iter2_reg <= icmp_ln121_reg_173_pp0_iter1_reg;
        icmp_ln121_reg_173_pp0_iter3_reg <= icmp_ln121_reg_173_pp0_iter2_reg;
        icmp_ln121_reg_173_pp0_iter4_reg <= icmp_ln121_reg_173_pp0_iter3_reg;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        mul5_i_reg_193 <= grp_fu_135_p_dout0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        mul6_i_reg_198 <= grp_fu_135_p_dout0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage4_11001) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
        sum_3_reg_214 <= grp_fu_76_p2;
        t_reg_203 <= grp_fu_87_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        x_reg_187 <= grp_fu_84_p1;
    end
end

always @ (*) begin
    if (((icmp_ln121_reg_173 == 1'd1) & (1'b0 == ap_block_pp0_stage4_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln121_reg_173_pp0_iter4_reg == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_sum_load_1 = sum_3_reg_214;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_80_p0 = mul5_i_reg_193;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_80_p0 = x_reg_187;
    end else begin
        grp_fu_80_p0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        grp_fu_80_p1 = x_reg_187;
    end else if (((1'b0 == ap_block_pp0_stage2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        grp_fu_80_p1 = scale2X;
    end else begin
        grp_fu_80_p1 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln121_reg_173_pp0_iter4_reg == 1'd1))) begin
...
assign add_ln121_fu_111_p2 = (ap_sig_allocacmp_i_5 + 3'd1);

assign add_ln122_fu_117_p2 = ($signed(ap_sig_allocacmp_i_5) + $signed(3'd5));
...
assign cf_address0 = trunc_ln122_cast_fu_136_p1;

assign cf_d0 = t_reg_203;

assign grp_fu_135_p_ce = 1'b1;

assign grp_fu_135_p_din0 = grp_fu_80_p0;

assign grp_fu_135_p_din1 = grp_fu_80_p1;

assign grp_fu_84_p0 = $signed(add_ln122_reg_177);

assign icmp_ln121_fu_105_p2 = ((ap_sig_allocacmp_i_5 == 3'd7) ? 1'b1 : 1'b0);

assign sum_3_out = sum_fu_42;

assign trunc_ln122_cast_fu_136_p1 = i_5_reg_168_pp0_iter4_reg;

endmodule //gaussian_filter_accel_GaussianBlur_7_0_16_3840_2160_1_2_2_Pipeline_VITIS_LOOP_121_1
