...
#define XGAUSSIAN_FILTER_ACCEL_CONTROL_ADDR_ROWS_DATA  0x10
#define XGAUSSIAN_FILTER_ACCEL_CONTROL_BITS_ROWS_DATA  32
#define XGAUSSIAN_FILTER_ACCEL_CONTROL_ADDR_COLS_DATA  0x18
#define XGAUSSIAN_FILTER_ACCEL_CONTROL_BITS_COLS_DATA  32
#define XGAUSSIAN_FILTER_ACCEL_CONTROL_ADDR_SIGMA_DATA 0x20
