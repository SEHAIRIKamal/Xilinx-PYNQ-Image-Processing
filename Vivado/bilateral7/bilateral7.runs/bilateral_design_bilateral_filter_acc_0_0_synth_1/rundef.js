...
ISEStep( "vivado",
         "-log bilateral_design_bilateral_filter_acc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bilateral_design_bilateral_filter_acc_0_0.tcl" );
