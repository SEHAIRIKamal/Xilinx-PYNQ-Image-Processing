...
HD_PWD='C:/Xilinx/workspace/bilateral7/bilateral7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bilateral_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bilateral_design_wrapper.tcl -notrace
