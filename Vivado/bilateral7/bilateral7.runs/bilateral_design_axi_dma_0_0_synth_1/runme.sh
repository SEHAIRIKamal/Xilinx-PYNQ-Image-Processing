...
HD_PWD='C:/Xilinx/workspace/bilateral7/bilateral7.runs/bilateral_design_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bilateral_design_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bilateral_design_axi_dma_0_0.tcl
