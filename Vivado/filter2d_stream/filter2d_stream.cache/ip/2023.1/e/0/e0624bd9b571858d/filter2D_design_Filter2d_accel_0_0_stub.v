...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ filter2D_design_Filter2d_accel_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_control_AWADDR, 
  ...
  img_in_TDEST, filter_val_TVALID, filter_val_TREADY, filter_val_TDATA, img_out_TVALID, 
  img_out_TREADY, img_out_TDATA, img_out_TKEEP, img_out_TSTRB, img_out_TUSER, img_out_TLAST, 
  img_out_TID, img_out_TDEST)
/* synthesis syn_black_box black_box_pad_pin="s_axi_control_AWADDR[5:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_BRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_ARADDR[5:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_RVALID,s_axi_control_RREADY,ap_rst_n,interrupt,img_in_TVALID,img_in_TREADY,img_in_TDATA[23:0],img_in_TKEEP[2:0],img_in_TSTRB[2:0],img_in_TUSER[0:0],img_in_TLAST[0:0],img_in_TID[0:0],img_in_TDEST[0:0],filter_val_TVALID,filter_val_TREADY,filter_val_TDATA[31:0],img_out_TVALID,img_out_TREADY,img_out_TDATA[23:0],img_out_TKEEP[2:0],img_out_TSTRB[2:0],img_out_TUSER[0:0],img_out_TLAST[0:0],img_out_TID[0:0],img_out_TDEST[0:0]" */
