...
module Filter2d_accel_axis2xfMat_24_16_3840_2160_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
Filter2d_accel_axis2xfMat_24_16_3840_2160_1_Pipeline_loop_col_zxi2mat grp_axis2xfMat_24_16_3840_2160_1_Pipeline_loop_col_zxi2mat_fu_108(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln63_fu_141_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln63_fu_141_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (imgInput_cols_c_full_n == 1'b0) | (imgInput_rows_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_76 <= 12'd0;
    end else if (((icmp_ln63_fu_141_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        i_fu_76 <= i_6_fu_146_p2;
    end
end

always @ (*) begin
    if (((ap_start == 1'b0) | (imgInput_cols_c_full_n == 1'b0) | (imgInput_rows_c_full_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln63_fu_141_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (imgInput_cols_c_full_n == 1'b0) | (imgInput_rows_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign icmp_ln63_fu_141_p2 = (($signed(zext_ln63_fu_137_p1) < $signed(p_read)) ? 1'b1 : 1'b0);
...
assign zext_ln63_fu_137_p1 = i_fu_76;

endmodule //Filter2d_accel_axis2xfMat_24_16_3840_2160_1_s
