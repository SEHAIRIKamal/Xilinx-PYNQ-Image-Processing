...
HD_PWD='C:/Xilinx/workspace/filter2d_stream/filter2d_stream.runs/filter2D_design_axis_dwidth_converter_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter2D_design_axis_dwidth_converter_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter2D_design_axis_dwidth_converter_1_0.tcl
