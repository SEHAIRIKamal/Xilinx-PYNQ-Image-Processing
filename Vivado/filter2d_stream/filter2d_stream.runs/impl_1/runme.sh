...
HD_PWD='C:/Xilinx/workspace/filter2d_stream/filter2d_stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log filter2D_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source filter2D_design_wrapper.tcl -notrace
