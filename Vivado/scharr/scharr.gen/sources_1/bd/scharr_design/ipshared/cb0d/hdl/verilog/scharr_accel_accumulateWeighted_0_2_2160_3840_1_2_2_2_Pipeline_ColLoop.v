...
module scharr_accel_accumulateWeighted_0_2_2160_3840_1_2_2_2_Pipeline_ColLoop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
scharr_accel_mul_24ns_8ns_32_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 24 ),
    .din1_WIDTH( 8 ),
...
scharr_accel_mac_muladd_24ns_8ns_32ns_33_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 24 ),
    .din1_WIDTH( 8 ),
...
assign p_dst_data_din = tmp_s_fu_141_p4;

assign tmp_s_fu_141_p4 = {{grp_fu_155_p3[32:23]}};
...
endmodule //scharr_accel_accumulateWeighted_0_2_2160_3840_1_2_2_2_Pipeline_ColLoop
