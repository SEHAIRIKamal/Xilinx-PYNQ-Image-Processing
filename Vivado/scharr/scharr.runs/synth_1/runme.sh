...
HD_PWD='C:/Xilinx/workspace/scharr/scharr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scharr_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scharr_design_wrapper.tcl
