...
HD_PWD='C:/Xilinx/workspace/scharr/scharr.runs/scharr_design_scharr_accel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scharr_design_scharr_accel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scharr_design_scharr_accel_0_0.tcl
