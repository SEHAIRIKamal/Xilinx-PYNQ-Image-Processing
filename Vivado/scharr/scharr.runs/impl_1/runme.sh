...
HD_PWD='C:/Xilinx/workspace/scharr/scharr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scharr_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scharr_design_wrapper.tcl -notrace
